  ...
  const handleFileUpload = (e) => {
    ...
    if (file && file.type === "text/csv") {
      ...
      reader.onload = (event) => {
        ...
        setCsvData(content); // You can parse it with PapaParse if needed
        ...
        <div className="import-data">
          ...
          <div className="upload-csv-section">
            <div className="drag-drop-area">
              ...
              <button className="upload-file-button" onClick={handleButtonClick}>
              ...
              />
              {uploadedFileName && (
                <p className="file-info">Uploaded: <strong>{uploadedFileName}</strong></p>
              )}
            </div>
          </div>
        </div>
